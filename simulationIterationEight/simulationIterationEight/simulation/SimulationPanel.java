...
public class SimulationPanel extends JPanel {
    ...
    public void setFoodSources(int count) {
        ...
        List<Color> foodColors = new ArrayList<>(); // Store colors for food sources

        // 🎨 Define a set of distinct colors for food sources
        Color[] FOOD_COLORS = {
        ...
        while (foodSources.size() < count) {
            ...
            if (!tooClose) {
                ...
                Color assignedColor = FOOD_COLORS[foodID % FOOD_COLORS.length]; // Assign color based on index
                ...
                foodColors.add(assignedColor); // Store color for graphing
            }
        }
